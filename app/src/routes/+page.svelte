	...
	{#if $showSplash}
		...
		>
			<div class="max-w-xl flex flex-col justify-center items-center space-y-4">
				...
				<p class=" font-bold font-display">
					This is a space game where everything is generated by AI.
				</p>
		...
		text-green-500 text-xs font-mono font-light"
				...
				<p>
					The AI is COMPLETELY in control! It will make up a story, track damage to your ship, and
					visualise anything remarkable you encounter.
				</p>
